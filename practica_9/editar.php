...
<center>
<h1><font color="White"> Editar Libros</font></h1>
<?php
include("cone.php");
...
<?php
  if(isset($_POST['editar'])){
    ...
    ?>
      <form method="post">
      <br/><br/>
      	<font color="White">autor:<input name= "a" value="<?php echo $a; ?>"/></font> <br /><br/>
      	<font color="White">titulo:<input name= "t" value="<?php echo $t; ?>"/></font><br /><br/>
      	<font color="White">editorial:<input name= "e" value="<?php echo $e; ?>"/> </font><br /><br/>
      	<font color="White">fecha_edicion:<input name= "f" value="<?php echo $f; ?>"/></font> <br /><br/>
      	<font color="White">SBN:<input name= "s" value="<?php echo $s; ?>"/></font> <br /><br/><br/>
