...
<center>
<h1> <font color="White">Agregar Libros</font></h1>
<form  action="" method="post">
     <font color="White"> autor:<input title="se necesita llenar el campo" required name="aut"><br/><br/>
      ...
      sbn:<input required name="sbn"><br/><br/></font>
